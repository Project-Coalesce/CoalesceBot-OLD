...
class EightBall: Embeddables {
    private val pos = java.awt.Color(112, 255, 45)
    private val neu = java.awt.Color(255, 227, 17)
    private val neg = java.awt.Color(206, 28, 28)
    ...
    fun eightBall(context: CommandContext, @VarArg question: String) {
        context(embed().apply {
            val answer = responses.entries.toList()[java.util.concurrent.ThreadLocalRandom.current().nextInt(responses.size)]
